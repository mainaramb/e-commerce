...
@Component({
  ...
  imports: [Produto, PrecoFormatadoPipe, UpperCasePipe, RouterLink,  MatButtonModule],
...
// MÉTODO HTTP CLINT (API)
  ...
  aoFavoritar(produto: ItemFavoritos) {
    this.favoritosFacade.favoritarProduto(produto);
  }
}
